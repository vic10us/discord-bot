...
namespace v10.Snowflakes.Extensions;
...
public static class IdExtensions
{
    ...
    public static Id ToId(this Discord discord)
    {
        long id = discord.UnixTimeMilliseconds - MonotonicTimer.Epoch.ToUnixTimeMilliseconds();
        id <<= 22;
        id |= discord.InternalWorkerID << 17;
        id |= discord.InternalProcessID << 12;
        id |= discord.Increment;

        return new Id(id);
    }

    public static Discord ToDiscordId(this Id id)
    {
        long timestamp = id >> 22;
        long workerId = (id >> 17) & 0b11111;
        long processId = (id >> 12) & 0b11111;
        long increment = id & 0b111111111111;

        return new Discord
        {
            UnixTimeMilliseconds = MonotonicTimer.Epoch.ToUnixTimeMilliseconds() + timestamp,
            InternalWorkerID = (short)workerId,
            InternalProcessID = (short)processId,
